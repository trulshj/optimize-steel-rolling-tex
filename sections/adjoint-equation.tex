...
To derive the gradient of our problem \eqref{eq:cost-func}, we differentiate the Lagrangian \eqref{eq:lagrangian-raw} again, but now with respect to the control $u$. We still differentiate in direction $h$, but now note that $h\in H^1(0, T)$. This gives
\begin{equation}
